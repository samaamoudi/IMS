<%@ Page Title="" Language="C#" MasterPageFile="~/CaseHandler.Master" AutoEventWireup="true" CodeBehind="CaseRequest.aspx.cs" Inherits="IMS2.CaseRequest" %>
    ...
    <div class="groove">
        ...
        <table style="width: 100%;">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="requestertxt" runat="server" CssClass="input" placeholder="Employee ID"></asp:TextBox>
                 ...
                 <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="requestertxt" Display="Dynamic" ErrorMessage="Please enter a valid employee ID" ForeColor="Red" ValidationExpression="^\d{5}$"></asp:RegularExpressionValidator>
                </td>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="accusedtxt" runat="server" class="input" placeholder="Employee ID"></asp:TextBox>
               ...
               <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="accusedtxt" Display="Dynamic" ErrorMessage="Please enter a valid employee ID" ForeColor="Red" ValidationExpression="^\d{5}$"></asp:RegularExpressionValidator>
                    </td>
...
<%--                      <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="DropDownList1" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>--%>
            ...
            <tr>
                ...
                <td>
                    ...
                    &nbsp;&nbsp;&nbsp;
                  <%--  <asp:Button ID="Button2" runat="server" Text="Cancel" CssClass="button button3" PostBackUrl="~/CaseRequest.aspx" OnClick="Button2_Click1" />--%></td>
